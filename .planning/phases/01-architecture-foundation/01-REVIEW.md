...
**File:** `Data/ItemRegistry.cs:38-41`
...
**File:** `Scenes/FarmScene.cs:50-51`
...
**File:** `Data/ItemRegistry.cs:66-67`
...
**Issue:** `Initialize` defaults to `"Data/items.json"` which is relative to the working directory. This works when running from the project root but may break if the working directory differs (e.g., running from `bin/Debug/net8.0/`).
