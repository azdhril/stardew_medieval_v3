...
public class Toast
{
    ...
    /// <summary>
    /// Replace the current toast. Any in-flight toast is cancelled in favor of the new one.
    /// </summary>
    ...
    /// <summary>Advance the toast timer. Deactivates after 2200 ms total.</summary>
